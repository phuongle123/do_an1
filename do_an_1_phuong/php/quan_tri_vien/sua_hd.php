...
<div id="content">
 ...
 <form  method="POST">
  <table width="400px" border="0" align="center" style="margin:10px auto; ">
 	 <tr>
    	<td> Mã cán bộ</td>
        <td><input name="macb" id="macb" type="text"/></td>
     </tr>
  	<tr>
    	<td> Tên cán bộ</td>
        <td><input name="tencb" id="tencb" type="text" /></td>
     </tr>
     <tr>
   		  <td> Giới tính</td>
    	 <td> 
     ...
     <tr>
     	<td>Quê quán</td>
        <td><input name="quequan" id="quequan" type="text" /></td>
     </tr>
     <tr>
     	<td>Chức vụ</td>
     ...
     <tr>
     	<td colspan="2" align="center"><input type="submit" value="sửa"  name"update"/></td>
        </tr>
        </table>
